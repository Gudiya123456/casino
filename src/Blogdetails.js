...
const Blogdetails = ({ }) => {
    ...
    const blogdetailData = async () => {
        try {
            const response = await axios.get(`http://casinosonlinein.com/1xbet/console/api/blogdetails/${blogid}`)
            ...
            <div className=' container mx-auto mt-5 mb-20'>
                <div className='grid grid-cols-12 gap-4'>
                    <div className=' col-span-12 lg:col-span-8'>
                        ...
                        <img src={`http://casinosonlinein.com/1xbet/console/public/storage/${blogdetails.image}`} alt="" className=' object-streach w-full h-[400px]' />
