...
function Events() {
    ...
    const eventData = async () => {
        try {
            const response = await axios.get('http://casinosonlinein.com/1xbet/console/api/liveevents')
                                ...
                                <div className=' col-span-12 lg:col-span-6 rounded-lg shadow-md'>
                                    <div className=' bg-light'>
                                        <a href="#" target='_blank'>
                                            <img src={`http://casinosonlinein.com/1xbet/console/public/storage/${event.image}`} alt="" className=' object-cover w-full' />
